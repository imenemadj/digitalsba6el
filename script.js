...
function showSuccessMessage(changed) {
  if (selectedFix.toLowerCase().includes("gemini")) {
    ...
    el("successMessage").textContent = "يرجى تفقد بريدك الإلكتروني خلال بضع ساعات. ستصلك دعوة باسم Google Family Invitation، يرجى قبول الدعوة لبدء تفعيل اشتراك Gemini Pro الخاص بك لمدة أربعة أشهر مباشرة.";
  } else {
